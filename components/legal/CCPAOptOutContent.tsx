...
export default function CCPAOptOutContent() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-16 w-full">
      ...
      <div className="prose prose-zinc max-w-none space-y-6 text-sm leading-relaxed text-soft-dark/80">
        ...
        <section>
          ...
          <p>For more information, view our <Link href="/privacy-policy" className="text-brand-blue hover:underline">Privacy Policy</Link>.</p>
          
          <p className="mt-4 p-4 bg-blue-50 border-l-4 border-brand-blue rounded text-soft-dark">
