...
export default function Pill({
    ...
    const activeStyles = "bg-brand-blue text-white border-brand-blue shadow-lg shadow-brand-blue/20 -translate-y-0.5  cursor-none";
    const inactiveStyles = "bg-warm-gray text-soft-dark border border-warm-gray hover:border-brand-blue hover:text-soft-dark";
