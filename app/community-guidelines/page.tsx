      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        ...
        <div className="prose prose-zinc max-w-none space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>We believe social media is meant to be social and we will respond to your questions and comments as quickly as possible. However, if we miss something or you need to get in contact with someone at OrthoNu fast, please visit our <a href="https://orthonu.com/pages/contact-us" className="text-brand-blue hover:underline" target="_blank" rel="noopener noreferrer">contact page</a>.</p>
          </section>
