    ...
    <div className="flex flex-col min-h-screen font-sans bg-white text-black">
      ...
      <main className="flex flex-col w-full font-sans">
        ...
        >
            ...
            <div className="pt-8 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                <Link
                  href={shopUrl}
                  target="_blank"
                  className="group relative px-8 py-4 bg-brand-blue text-white rounded-full font-bold text-sm tracking-wide transition-all hover:bg-atlantic-blue hover:shadow-[0_0_30px_rgba(30,174,219,0.3)] hover:-translate-y-1 overflow-hidden"
                >
                ...
                <a
                  ...
                  className="px-8 py-4 bg-white text-soft-dark border border-zinc-200 rounded-full font-bold text-sm tracking-wide transition-all hover:bg-zinc-50 hover:border-zinc-300"
                >
                  Partner with Us
                </a>
              </div>
          ...
          <div
            className="absolute bottom-1/4 -right-12 w-96 h-96 bg-soft-plum/5 rounded-full blur-3xl animate-pulse"
