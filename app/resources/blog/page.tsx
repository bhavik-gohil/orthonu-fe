...
export default function BlogPage() {
    const [activeCategory, setActiveCategory] = useState<BlogProductCategory | "All">("All");
        ...
        <div className="flex flex-col min-h-screen bg-warm-gray text-soft-dark font-sans">
            ...
            <main className="flex-1">
                ...
                <section className="bg-brand-blue text-white py-20 md:py-28 px-6 text-center">
                    <div className="max-w-2xl mx-auto space-y-4">
                        ...
                        <p className="text-white/70 text-lg font-medium">
                            Clinical insights, patient stories, and the latest from the OrthoNu team.
                        </p>
                    </div>
                </section>
                ...
                <div className="max-w-5xl mx-auto px-6 py-14">
                    ...
                    {/* ── Featured Post ── */}
                    {featured && (
                        <Link href={`/resources/blog/${featured.slug}`} className="group block mb-14">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-zinc-100 bg-white shadow-sm hover:shadow-xl hover:shadow-brand-blue/5 transition-all duration-300">
                                ...
                                <div className="p-8 md:p-10 flex flex-col justify-center gap-4">
                                    <div className="flex items-center gap-2 text-zinc-400">
                                        <Calendar size={13} />
                                        <span className="text-xs font-medium">{formatDate(featured.date)}</span>
                                    ...
                                    <p className="text-zinc-500 text-sm leading-relaxed">{featured.excerpt}</p>
